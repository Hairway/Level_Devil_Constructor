...
export default class Physics2dBox2d extends IMPION.ComponentEmpty{
	...
	constructor({fps = 60, order = ""}){
		...
		this.world = new b2World( new b2Vec2(0, -12) );
    }
	...
	//						physicsObject.position[0],
	//						physicsObject.position[1],
	//						physicsObject.shapes[i].radius,
	//						0,
	//						2*Math.PI
	//					);
	//				
	//					this.debugObject.moveTo(physicsObject.position[0], physicsObject.position[1]);
	//					this.debugObject.lineTo(
	//						physicsObject.position[0] + physicsObject.shapes[i].radius*Math.cos(physicsObject.angle),
	//						physicsObject.position[1] + physicsObject.shapes[i].radius*Math.sin(physicsObject.angle)
	//					);		
	//					
	//				}
	//			}
