...
export default class CreateDebugGUI extends IMPION.Debug3dGUI{
	...
	//	
	//	let materials = {
	//		'Material 1': new IMPION.MeshLambertMaterial3d({ color: 0xff0000 }),
	//		'Material 2': new IMPION.MeshLambertMaterial3d({ color: 0x00ff00 }),
	//		'Material 3': new IMPION.MeshLambertMaterial3d({ color: 0x0000ff })
	//	};
	//	
