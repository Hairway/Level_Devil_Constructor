...
export default class Game extends IMPION.ComponentEmpty {
	...
	//	this.#app.soundManager.volume("bg_0", 0.2);
		...
		//gsap.set(this, {delay:0.1, overwrite: "none", onComplete:this.failGame});
		//gsap.set(this, {delay:0.1, overwrite: "none", onComplete:this.winGame});
    }
    ...
    failGame = (e) => {
		if(this.#state != 10){
			...
			if(this.#app.params.fullscreenCta.value){
				gsap.set(this.components["FullscreenCTA"],				{delay:2.0, overwrite: "none", visible:true});
			}
		}
    }
