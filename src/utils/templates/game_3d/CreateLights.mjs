...
export default class CreateLights{
	...
	constructor({app, gameComponent}){
		...
		//this.lights["AmbientLight"] = new IMPION.AmbientLight3d( 0xfffed9, 2.0);
		//this.#app.view3d.scene.add( this.lights["AmbientLight"]  );
		
		this.lights["HemisphereLight"] = new IMPION.HemisphereLight3d( 0xfef4e1, 0xfee1e1, 2.0);
		this.#app.view3d.scene.add( this.lights["HemisphereLight"]  );
		
		this.lights["DirectionalLight"] = new IMPION.DirectionalLight3d( 0xfffed9, 2.2);
